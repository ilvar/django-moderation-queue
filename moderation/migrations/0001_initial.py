...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('moderation_changeset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_pk', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('moderation_status', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
            ('moderated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderated_by_set', to=orm['auth.User'])),
            ...
            ('object_diff', self.gf('picklefield.fields.PickledObjectField')()),
        ))
        db.send_create_signal('moderation', ['Changeset'])


    def backwards(self, orm):
        # Deleting model 'Changeset'
        db.delete_table('moderation_changeset')
    ...
    models = {
        ...
        'moderation.changeset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'moderated_by_set'", 'to': "orm['auth.User']"}),
